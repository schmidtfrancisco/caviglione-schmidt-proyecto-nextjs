export default function DeleteWarning({onClose}: {onClose: () => void}) {
	return (
		<div className="border rounded-lg shadow relative max-w-sm">
			...
			<div className="p-6 pt-0 text-center">
					...
					<h3 className="text-xl font-normal text-gray-500 mt-5 mb-6">¿Estas seguro de que deseas eliminar esta orden?</h3>
					<a href="#"
